                    ...
                    {newExamQuestions.map((question, index) => (
                      <div key={index} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div>
                            <label className={`block text-sm font-medium text-gray-700 mb-1 ${question.hasIntervention ? '' : 'text-gray-400 cursor-not-allowed blur-sm'}`}>
                            ...
                            <input
                              ...
                              className={`block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${question.hasIntervention ? '' : 'text-gray-400 cursor-not-allowed blur-sm'}`}
                              placeholder="e.g., 15.5"
                              step="0.1"
                              disabled={!question.hasIntervention}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            {showAddQuestionForm && (
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="newCorrectTime" className={`block text-sm font-medium text-gray-700 mb-1 ${newQuestion.hasIntervention ? '' : 'text-gray-400 cursor-not-allowed blur-sm'}`}>
                      Correct Time (seconds)
                    </label>
                    <input
                      type="number"
                      ...
                      className={`block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${newQuestion.hasIntervention ? '' : 'text-gray-400 cursor-not-allowed blur-sm'}`}
                      placeholder="e.g., 15.5"
                      step="0.1"
                      disabled={!newQuestion.hasIntervention}
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
